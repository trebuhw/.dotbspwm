...
PACKAGES=(
  ...
  picom rofi stow desktop-base nsxiv zathura vim neovim btop tmux
)
...
### INSTALL DOTFILES (STOW) WITH INDIVIDUAL BACKUP
# backup existing files
mv ~/.bashrc ~/bashrc.bak
mv ~/.bash_logout ~/.bash_logout.bak
mv ~/.config/bash ~/.config/bash.bak
mv ~/.config/bspwm ~/.config/bspwm.bak
mv ~/.config/dmrc ~/.config/dmrc.bak
mv ~/.gtkrc-2.0 ~/gtkrc-2.0.bak
mv ~/.profile ~/.profile.bak

# Stow
ln -sf $SCRIPT_DIR/.dotfiles ~/.dotfiles
cd ~/.dotfiles
